...
class Locale
{
    ...
    {
        $locales = LocaleModel::where('is_enabled', 1)->get();
        foreach ($locales as $locale) {
            // $locale = new self();
            // $locale->is_enabled = $locale->is_enabled;
        ...
        return self::$cacheFromSites = new Collection($localeList);
    ...
    {
        $languages = array_keys(LocaleModel::listEnabled());
